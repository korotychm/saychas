    ...
    public function init($forceCreate = false)
    {
        ...
        if (!$result) {
            ...
            foreach ($roles as $role) {
                ...
                $parents = \Application\Helper\ArrayHelper::getParents(['child_role_id' => $role['id'], 'parent_role_id' => $role['parent_role_id']], $hierarchy/*$roles*/, [], 'child_role_id', 'parent_role_id');
                $parentRoleNames = [];
