 ...
 * @author alex
 */
class StoreManager extends ListManager implements LoadableInterface
{

//    use Loadable;

    // public const COLLECTION_NAME = 'stores';
    protected $collectionName = 'stores';
    ...
    {
        $url = $this->config['parameters']['1c_provider_links']['lk_update_store'];
