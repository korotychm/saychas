          ...
          <div class="cp-container list orders" v-if="orders">
              ...
              <div class="tbody">
                <div class="tr orders__item" v-for="(order,index) in orders">
                    ...
                    <div class="td orders__short" v-show="activeOrder !== order.id && order.status_id != '01'">
                    ...
                    <div class="td orders__full" v-show="activeOrder === order.id || order.status_id == '01'">
                        <div class="orders__product" v-for="product in order.items" :class="{'orders__product--zero' : (product.qty_partner == 0)}">
                            ...
                            <div class="orders__product-count" v-if="order.status_id != '01' && product.qty_partner < product.qty">
                            ...
                            <div class="orders__product-count" v-if="order.status_id != '01' && product.qty_partner == product.qty"><b>{{ product.qty_partner }}</b> шт</div>
                    ...
                    <div class="td orders__btn" v-if="order.status_id == '00'">
                    ...
                    <div class="td orders__btn" v-else-if="order.status_id == '01'">
                    ...
                    <div class="td orders__btn" v-else>
                      <div class="orders__ready-date" v-if="order.status_id != '04'">Собран {{ localeDate(order.status_date) }}</div>
