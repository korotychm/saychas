        ...
        <div style="height: 600px">
          <yandex-map :settings="settings" :coords="coords" zoom="10" :controls="controls">
            <div v-for="store in stores">
              <ymap-marker :markerId="store.id" marker-type="Placemark" :coords="[store.geox,store.geoy]" :hint-content="'<h3>' + store.title + '</h3><p>' + store.address + '</p><a href=`#`>Редактировать</a>'"></ymap-marker>
            </div>
          </yandex-map>
        </div>
      </div>
